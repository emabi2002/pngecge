/**
 * PNGEC-BRS Full Database Setup
 *
 * This script:
 * 1. Checks if the schema is applied
 * 2. If not, provides instructions to apply it
 * 3. If yes, seeds the initial data
 */
...
async function seedDatabase() {
  ...
  if (existingProvinces > 0) {
    console.log('⚠️  Database already has data. Showing current counts:\n');
    const tables = ['provinces', 'districts', 'users', 'devices', 'system_stats'];
  ...
  // Insert provinces
  console.log('🌍 Inserting 22 PNG provinces...');
  ...
  // Insert districts
  console.log('🏘️  Inserting districts for major provinces...');
  ...
  console.log(`  ✅ Created admin: ${adminUser[0].email}`);

  // Insert devices
  console.log('📱 Creating registration devices...');
  const devices = [
    {
...
async function main() {
  ...
  console.log('║   Papua New Guinea Electoral Commission                ║');
  console.log('║   Biometric Registration System                        ║');
  console.log('╚════════════════════════════════════════════════════════╝\n');

  // Step 1: Check if tables exist
  console.log('🔍 Checking database schema...\n');

  const coreTables = ['provinces', 'districts', 'users', 'devices', 'voter_registrations'];
  ...
  if (!allTablesExist) {
    console.log('\n╔════════════════════════════════════════════════════════╗');
    console.log('║  ⚠️  SCHEMA NOT FOUND - Manual Setup Required          ║');
    console.log('╚════════════════════════════════════════════════════════╝\n');

    console.log('The database tables have not been created yet.');
    console.log('Please follow these steps:\n');

    console.log('┌─────────────────────────────────────────────────────────┐');
    console.log('│ STEP 1: Open Supabase SQL Editor                        │');
    console.log('├─────────────────────────────────────────────────────────┤');
    console.log('│ https://supabase.com/dashboard/project/wpzdecsalrsftaocmovg/sql/new');
    console.log('└─────────────────────────────────────────────────────────┘\n');

    console.log('┌─────────────────────────────────────────────────────────┐');
    console.log('│ STEP 2: Copy and paste the schema SQL                   │');
    console.log('├─────────────────────────────────────────────────────────┤');
    console.log('│ The schema file has been copied to:                     │');
    console.log('│ ./supabase/schema.sql                                   │');
    console.log('└─────────────────────────────────────────────────────────┘\n');

    console.log('┌─────────────────────────────────────────────────────────┐');
    console.log('│ STEP 3: Click "Run" to execute the SQL                  │');
    console.log('└─────────────────────────────────────────────────────────┘\n');

    console.log('┌─────────────────────────────────────────────────────────┐');
    console.log('│ STEP 4: Run this script again to seed data              │');
    console.log('├─────────────────────────────────────────────────────────┤');
    console.log('│ bun scripts/full-setup.js                               │');
    console.log('└─────────────────────────────────────────────────────────┘\n');
    ...
    console.log('  • 13 tables (provinces, districts, llgs, wards, etc.)');
    console.log('  • 10 custom enum types');
    console.log('  • 16 performance indexes');
    console.log('  • Row Level Security (RLS) policies\n');

    // Save schema URL for easy access
    console.log('Direct link to SQL Editor with schema:');
    console.log('https://supabase.com/dashboard/project/wpzdecsalrsftaocmovg/sql/new\n');
